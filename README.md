...
***EXTREME WARNING- "Any government employee who participated IN AND WAS GIVEN IMMUNITY BY ANY GOVERNMENT in the 'Crime Olympics ARPG' 'Spy Caper ARPG' 'Cold War Idiots ARPG' 'Crime Wars ARPG', OR THE CURRENT 'Spy Wedding ARPG' ** REASON: You are at war with UFW/ Offplanet UN, Creative Genius (Not related to American forces in anyway) and the American government on every timeline. You're counterparts on other timelines are being hunted until they get to this timeline. ***EXTREME WARNING": DO NOT CONTACT ME UNDER ANY CIRCUMSTANCES EVEN THROUGH THE DOJ.***
